...
<body>
    <section id="section3">
        <table class="tab2">
            <tr style="background-color: yellow;">
                <td class="post_header"><a href="../question.php" target="_blank" style="font-size: 20px;">Previous Year Question Papers </a></td>
                <td><a href="../question.php" target="_blank">Link</a></td>
            </tr>
        </table>
    </section>
    ...
    <p class="copyright">Copyright@ indiangovermentjobs | <a href="mailto:indiangovermentjobs.helpline@gmail.com">Contact</a> | <a href="../index.php" target="_self">Home</a> | <a href="../aboutus.php" target="_self">About</a></p>
    <script>
